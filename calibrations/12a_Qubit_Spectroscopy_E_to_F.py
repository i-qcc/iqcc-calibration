...
def create_qua_program(node: QualibrationNode[Parameters, Quam]):
    ...
    amp = node.parameters.operation_amplitude_factor
            ...
            with for_(n, 0, n < n_avg, n + 1):
                ...
                with for_(*from_array(df, dfs)):
                    for i, qubit in multiplexed_qubits.items():
                        ...
                        qubit.xy.play("x180")
                        # Update the qubit frequency to scan around the expected f_01 - anharmonicity
                        update_frequency(
                            qubit.xy.name, df + qubit.xy.intermediate_frequency - qubit.anharmonicity
                        )
