...
def plot_data(node: QualibrationNode[Parameters, Quam]):
    ...
    fig_iq = plot_iq_blobs(ds_raw, qubits, ds_fit)
    fig_confusion = plot_confusion_matrices(ds_raw, qubits, ds_fit)
    fig_snr = plot_snr_gaussians(ds_raw, ds_fit, qubits, node)
